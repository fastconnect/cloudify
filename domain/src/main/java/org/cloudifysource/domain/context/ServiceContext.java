...
public interface ServiceContext {
	 ...
	 * Azure specifics.
	 * 
	 * @return interface for executing azure file storage
	 */
	AzureStorageFacade getAzureStorage();
	...
	/**
	 * Enables the host machine failure detection for a specific service instance. Machine failure or restart will
	 * result in the provisioning of a new machine instance.
	 * 
	 */
	void stopMaintenanceMode();

	/**
	 * Disables the host machine failure detection for a specific service instance. During the time period provided,
	 * machine state will be ignored and hence a new machine instance will NOT be auto-started upon machine failure or
	 * restart.
	 * 
	 * @param timeout
