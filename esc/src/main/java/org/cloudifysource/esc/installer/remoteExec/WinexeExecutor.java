...
/********
 * Remote Executor implementation for Windows Remote Management, using the powershell command.
 * 
 * @author victor
 * @since 2.7.0
 * 
...
public class WinexeExecutor implements RemoteExecutor {
	...
	private void executeWinexeCommand(final String host, String username, String password, String command)
