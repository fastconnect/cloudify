...
/**************************************************************************************
 * This class is responsible for creating an appropriate SSL Context for making requests to azure over SSL. uses a pfx
 * format file and the password that protects it. NOTE : in order for this to work the .cer file that is associated with
 * the .pfx must be uploaded as a management certificate via the azure portal.
 * 
 * @author elip
 * 
 **************************************************************************************/
